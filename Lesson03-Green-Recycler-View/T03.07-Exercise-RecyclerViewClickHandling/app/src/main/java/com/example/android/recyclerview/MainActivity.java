...
public class MainActivity extends AppCompatActivity
        implements GreenAdapter.ListItemClickLister{
     ...
     */
    @Override
    public void onListItenClick(int clickedItemIndex) {
        if(mToast != null){
            mToast.cancel();
        }

        String toastMassage = "Item #" + clickedItemIndex+ " clicked.";
        mToast = Toast.makeText(this, toastMassage, Toast.LENGTH_LONG);
        mToast.show();
    }
}
